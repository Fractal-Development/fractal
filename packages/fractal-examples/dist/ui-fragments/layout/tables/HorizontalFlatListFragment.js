...
function Table() {
    ...
    return (React.createElement(HorizontalFlatList, { key: width, rowWidth: 100, rowHeight: 150, dataProvider: dataProviderState, rowRenderer: rowRendererHorizontalTable }));
}
