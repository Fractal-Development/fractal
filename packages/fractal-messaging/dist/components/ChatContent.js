...
export function ChatContent(_a) {
    var { messages, onFavoritePress, onSharePress, messageActions, onSend, placeholder = 'Escribe aquí...', isLoading, keyboardAvoidingViewProps } = _a, layerProps = __rest(_a, ["messages", "onFavoritePress", "onSharePress", "messageActions", "onSend", "placeholder", "isLoading", "keyboardAvoidingViewProps"]);
