...
const AudioControls = memo(({ isPlaying, isEnableShuffle, isEnableRepeat, onPlayPausePress, onNextPress, onPreviousPress, onShufflePress, onRepeatPress }) => (React.createElement(Layer, { flexDirection: 'row', alignItems: "center", justifyContent: "space-between" },
