...
export function StackScreen(_a) {
    ...
    return (React.createElement(NavigationRoute, Object.assign({ top: 0, left: 0, right: 0, bottom: 0, position: 'absolute' }, others, { onDismissed: goBack, stackPresentation: stackPresentation, path: path }),
