...
export declare type XYPair = {
    y: number;
    x: number;
};
export declare type Coordinates = Array<XYPair>;
declare type GridDirection = 'VERTICAL' | 'HORIZONTAL' | 'BOTH';
...
export declare type ScaleType<Range, Output> = ScaleLinear<Range, Output> | ScaleLogarithmic<Range, Output> | ScalePower<Range, Output> | ScaleTime<Range, Output>;
declare type AccessorFunction<T, U> = (props: AccessorFunctionProps<T>) => U;
export declare type ScaleFunction = () => ScaleType<any, any> | ScaleBand<any>;
export declare type ScaleLinearFunction = typeof scaleLinear;
