...
import { CircularIconButton } from '@bma98/fractal-ui';
...
export function CircularTabBarItem(_a) {
    ...
    return (React.createElement(CircularIconButton, Object.assign({ height: 48, width: 48 }, others, { onPress: handlePress }), renderChildren));
}
