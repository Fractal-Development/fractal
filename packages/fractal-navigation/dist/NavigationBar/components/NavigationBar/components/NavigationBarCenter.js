...
export const NavigationBarCenter = memo(({ children, title }) => {
    ...
    return (React.createElement(Layer, { justifyContent: 'center', flex: 1, flexDirection: 'row', alignItems: 'center', flexBasis: 0 }, children || (title ? (React.createElement(Text, Object.assign({}, navigationBar.title, { textAlign: "center", numberOfLines: 1, style: titleStyle }), title)) : null)));
});
