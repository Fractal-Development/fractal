...
export const NavigationBarBackground = memo(({ children }) => {
    ...
    return (React.createElement(Layer, { backgroundColor: navigationBar.backgroundColor, flexDirection: 'row', height: navigationBar.height, boxShadow: navigationBar.shadow, zIndex: 2000, paddingLeft: spacings.m, paddingRight: spacings.m, position: navigationBarBackgroundCSSPosition, top: 0, left: left, right: right }, children));
});
