...
export function CircularIconButtonFragment() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Box, { marginTop: spacings.s, marginBottom: spacings.xl },
            ...
            React.createElement(CircularIconButton, { variant: 'alternative', marginBottom: spacings.s }, (color) => React.createElement(SearchIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'alternative', marginBottom: spacings.s, disabled: true }, (color) => React.createElement(SearchIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'alternative', marginBottom: spacings.s, reduceColor: true }, (color) => React.createElement(SearchIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'alternative', marginBottom: spacings.s, reduceColor: true, disabled: true }, (color) => React.createElement(SearchIcon, { height: 24, width: 24, fill: color })),
            ...
            React.createElement(CircularIconButton, { variant: 'warning', marginBottom: spacings.s }, (color) => React.createElement(MoreVerticalIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'warning', marginBottom: spacings.s, disabled: true }, (color) => React.createElement(MoreVerticalIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'warning', marginBottom: spacings.s, reduceColor: true }, (color) => React.createElement(MoreVerticalIcon, { height: 24, width: 24, fill: color })),
            React.createElement(CircularIconButton, { variant: 'warning', marginBottom: spacings.s, reduceColor: true, disabled: true }, (color) => React.createElement(MoreVerticalIcon, { height: 24, width: 24, fill: color })),
